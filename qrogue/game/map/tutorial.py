...
from qrogue.game.actors.factory import EnemyFactory, TargetDifficulty
from qrogue.game.actors.enemy import Enemy as EnemyActor
...
from qrogue.game.collectibles.collectible import ShopItem
from qrogue.game.collectibles import pickup
from qrogue.game.expedition import Expedition
from qrogue.game.logic.instruction import CXGate, HGate
...
from qrogue.game.map.rooms import Room, SpawnRoom, GateRoom, WildRoom, BossRoom, ShopRoom, RiddleRoom, Hallway, AreaType
...
class TutorialEnemyFactory(EnemyFactory):
    def __init__(self, start_fight_callback):
